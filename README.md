...
|---------|---------------------|------------|
| **SmartExtract AI** | GenAI, Python, LangChain, Gemini | Document extraction platform that converts unstructured PDFs into structured JSON schemas utilizing LangChain, Google Gemini, and Pydantic. Deployed via Streamlit. |
| **IIITN ECE Buddy** | GenAI, Python, Streamlit | Specialized AI assistant for ECE students at IIIT Nagpur. Integrates GenAI models to process and retrieve topics like Waveguides and Antennas. |
| **Movie Review Analyzer** | NLP, Python, Streamlit | Analyzes movie review sentiments using the IMDB dataset. Achieved a **90% accuracy rate** and deployed as an interactive web app. |
| **Digit Recognition App** | ANN, Python | Computer vision app recognizing handwritten digits using the MNIST dataset, designed and trained using an Artificial Neural Network. |
| **Heart Stroke Predictor** | Machine Learning, KNN | Predictive ML model assessing stroke risk factors utilizing the K-Nearest Neighbors algorithm with an **87% prediction accuracy**. |
